    ...
    <section className="px-6 py-16 md:py-[70px]">
      <div className="mx-auto max-w-[1440px] text-center">
        ...
        <p className="mx-auto  max-w-2xl font-body  font-[400] text-[16px] text-ink/60 md:text-[16px]">
          ...
          february. <br /> Superbae gives you the baefam support and structure to
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4 md:flex-nowrap">
          {pillars.map((pillar) => (
            ...
            >
              ...
              >
                <span
                  className="mt-6 flex min-h-[64px] w-full max-w-[273px] items-center justify-center rounded-[32px] border-[3px] px-4 py-3 text-center font-display text-[16px] font-bold text-white shadow-[inset_0px_-3px_3px_0px_rgba(0,0,0,0.25),inset_0px_5px_5px_0px_rgba(255,255,255,0.25)]"
                  style={{
                ...
                <p className="mt-auto whitespace-pre-line pb-6 font-display flex items-center justify-center text-center text-[28px] font-[500] leading-[1.3] text-ink md:items-start md:justify-start md:text-left md:text-[22px]">
                  {pillar.body}
                </p>
              </div>
            </div>
