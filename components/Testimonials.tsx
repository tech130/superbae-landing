...
function TestimonialCard({ src, video }: Omit<Testimonial, "id">) {
  ...
  return (
    ...
    >
      ...
      <span
        className={`absolute top-1/2 flex size-[50px] -translate-y-1/2 items-center justify-center rounded-full  text-2xl transition-all duration-300 ${hovered ? "scale-100 bg-black" : ""
          }`}
      >
